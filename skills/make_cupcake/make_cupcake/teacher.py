...
from make_cupcake.sensors import sensors

# The BaseTeacher class manages training and evaluation for the cupcake production skill.
...
class BaseTeacher(SkillTeacher):
    ...
    async def compute_reward(self, transformed_obs, action, sim_reward):
        ...
        # Reward is the count of completed cupcakes.
