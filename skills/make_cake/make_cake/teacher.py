...
from make_cake.sensors import sensors

# The BaseTeacher class manages training and evaluation for a skill focused on cake production.
# It includes logic for processing observations, computing rewards, and masking actions.
class BaseTeacher(SkillTeacher):
    def __init__(self, *args, **kwargs):
        ...
        Attributes:
            ...
            error_history: Records any error metrics during training.
    ...
    async def compute_reward(self, transformed_obs, action, sim_reward):
        ...
        For this teacher, the reward is directly tied to the number of cakes completed.
        ...
        # Reward is the count of completed cakes.
